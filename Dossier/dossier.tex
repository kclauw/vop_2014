...
Applicaties worden geschreven in JavaFX Script , een declaratieve scripttaal die speciaal is ontwikkeld voor webontwikkelaars en designers die visueel willen programmeren. 
...
\subsection{Gedcom}
* Exporteren van gedcom bestanden
...
* Meerdere stambomen uit een gedcom bestand importeren
...
*Toevoegen van een gedcom bestand aan een stamboom
 
\subsection{Stambomen}
* Printen van een stamboom
* Personen verplaatsen tussen stambomen
* Samenvoegen van stambomen
* In 3D wandelen door een stamboom
* Exporteren en importeren van stambomen in bepaalde formaten zoals pdf , word , excel ,scv ..
...
* Het importeren van gegevens uit andere databanken die gebruik maken van de applicatie
* Een statistisch overzicht van de verschillende acties in de applicatie
...
* Bij het wijzigen van de user in de useroverviewpanel worden alle users terug opgehaald na een wijziging , het zou efficienter zijn om enkel de gewijzigde persoon terug op te halen.
